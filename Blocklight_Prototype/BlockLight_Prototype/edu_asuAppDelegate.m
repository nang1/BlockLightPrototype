...
// JNN: added -fno-objc-arc tag in compile settings

#import "edu_asuAppDelegate.h"

@implementation edu_asuAppDelegate
...
- (void)dealloc {
    //JNN: ARC forbids explicit message send of "release" and "dealloc"
    [_window release];
    [super dealloc];
}

- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    //JNN: ARC forbids explicit message send of "autorelease"
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Blocklight_Prototype" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Blocklight_Prototype.sqlite"];
